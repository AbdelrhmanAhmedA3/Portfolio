...
const menu_hide_btn2 = document.querySelector(".menu_hide_btn2");
const menu_hide_btn3 = document.querySelector(".menu_hide_btn3");
const menu_hide_btn4 = document.querySelector(".menu_hide_btn4");
const menu_hide_btn5 = document.querySelector(".menu_hide_btn5");
const menu_hide_btn6 = document.querySelector(".menu_hide_btn6");
const show_menu = "show_menu";


menu_show_btn.addEventListener("click", funShow);
menu_hide_btn.addEventListener("click", funHide);
menu_hide_btn2.addEventListener("click", funHide);
menu_hide_btn3.addEventListener("click", funHide);
menu_hide_btn4.addEventListener("click", funHide);
menu_hide_btn5.addEventListener("click", funHide);
menu_hide_btn6.addEventListener("click", funHide);
function funShow() {
